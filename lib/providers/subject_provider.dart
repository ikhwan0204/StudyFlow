...
class SubjectProvider with ChangeNotifier {
  ...
  // Accept a full Subject model (used by dialogs that build a Subject instance)
  void addSubjectModel(Subject subject) {
    HiveService.subjectsBox.put(subject.id, subject);
    _loadSubjects();
  }
